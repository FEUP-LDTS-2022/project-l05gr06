...
public interface GUI {
    ...
    enum ACTION {UP, JACOB_RIGHT, DOWN, JACOB_LEFT, NONE, QUIT, SELECT, ESCAPE, SHAPE_LEFT, SHAPE_RIGHT, SHAPE_ROTATE_CLOCK_WISE,SHAPE_ROTATE_ANTI_CLOCK_WISE, SPACE}
    enum COLOR {RED, YELLOW, BLUE, PURPLE, ORANGE, GREEN, PINK, CYAN, BRICK, WHITE, BLACK}
    enum NAME_STATES{INSTRUCTION,PAUSE,SELECT_MODE,SETTINGS,START_MENU,GAME_OVER, LEADERBOARD}
}
